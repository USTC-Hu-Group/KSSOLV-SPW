function [mol, POS, POSRecMat, FORCE, FORCERecMat, Etot, INFO, exitFlag] = quenchbyfire(mol, mass, pars, opts, scfOpts)
% 
% Subhajit Banerjee
% June 2017
% SSG@CRD, LBNL
...
[x, v, F, mol, H, ~, info] = velverletfire(mol, verletParams, scfOpts);
% 
it = 0;
cut = 0;
exitFlag = false;
...
function [x, v, F, mol, H, X, info] = velverletfire(mol, params, scfOpts)
% 
% Subhajit Banerjee
% June 2017
% SSG@CRD, LBNL
...
[mol, H, X, info] = scf4m(mol, scfOpts);     % This should be the only SCF cycle
