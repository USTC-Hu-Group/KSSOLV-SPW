classdef Wavefun
    ...
    %
    %    X = WAVEFUN(psi,n1,n2,n3,idxnz,ispin) constructs compact wave 
    %    functions used in spin-polarized calculations. And ispin indicates 
    %    the spin label as 1 or 2 corresponding to spin-up and spin-down.
    %
