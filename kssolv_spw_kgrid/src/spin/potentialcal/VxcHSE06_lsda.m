function [vxc,uxc,rho] = VxcHSE06_lsda(mol,rho)
% GGA functional for LSDA 
% Different from VxcHSE06, short range exchange energy has been subtract
% in uxc
    e2 = e2Def();
    ...
    uxc = zeros(mol.n1,mol.n2,mol.n3);
...
% GGA correction by gradient of rho
    ...
    [ex,ec,v1x,v2x,v1c,v2c,v2c_ud] = Vxc_gcx(rho,grho,1);
